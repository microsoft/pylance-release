...
| [Docstring Resolution Order](howto/docstring-resolution-order.md)                   | How a language server picks which docstring to show among modules, classes, functions, `__init__`/`__new__`, overloads, overrides, and multiple inheritance |
