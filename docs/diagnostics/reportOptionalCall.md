...
result = callback()  # Error: Object of type "None" is not callable
```
...
- [How to Use Type Narrowing to Fix Type Errors](../howto/type-narrowing.md) — check for `None` before calling
