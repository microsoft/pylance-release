...
```python
class _InternalHelper:  # Defined but never referenced
    pass
...
**Fix — remove the unused class or use it:**
...
Or, if the class is used elsewhere, make sure it’s imported or referenced:
