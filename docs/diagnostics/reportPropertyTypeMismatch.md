...
class Widget:
    ...
    @color.setter
    def color(self, value: int):  # Setter accepts int, getter returns str
        self._color = str(value)
```

**Fix — make setter and getter types consistent:**
...
class Widget:
    ...
    @color.setter
    def color(self, value: str):  # Now matches getter return type
        self._color = value
```
