...
- **Scope of the Setting**:
    - The `python.analysis.nodeExecutable` setting is a _user-level_ setting.
...
**A:** When using either a manually installed Node.js executable or the automatic setting (`"auto"`), Pylance sets Node.js to use 8GB of heap by default. You can adjust the heap size using the [`python.analysis.nodeArguments`](python_analysis_nodeArguments.md) setting — for example, `["--max-old-space-size=16384"]` for 16GB.
